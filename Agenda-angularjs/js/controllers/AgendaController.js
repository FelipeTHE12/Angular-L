angular.module("agenda").controller("agendaController", function($scope, contactAPI, operadoraAPI, serialGenerator){
    ...
    var loadContact = function () {
        contactAPI.getContact().then(function (data, status) {
            $scope.contacts = data.data;
        }).catch(function (err, status) {
            $scope.message = "Houve um erro: " + data;
        });
    };

    var loadOperadoras = function () {
        operadoraAPI.getOperadoras().then(function(data, status) {
